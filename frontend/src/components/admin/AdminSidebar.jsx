        ...
        <ul>
          ...
          {canAccessSystemLogs() && (
            <>
              ...
              <li>
                <NavLink
                  to="/admin/prompt-injection-logs"
                  className={({ isActive }) => (isActive ? "active" : "")}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  {!collapsed && <span>Prompt Injection</span>}
                </NavLink>
              </li>
              <li>
                <NavLink
                  to="/admin/auth-error-logs"
                  className={({ isActive }) => (isActive ? "active" : "")}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  {!collapsed && <span>Auth Logları</span>}
                </NavLink>
              </li>
              <li>
                <NavLink
