...
* ✅ 'projects', to group chats (like gpt has.)
...
* hazır prompt şablonları, kullanıcı ekleyebilir veya admin panelden yönetilecek şekilde olabilir (tuğberk hocanın repodaki gibi)
    ...
    * bu biraz ekstra, olmasa da olur.
* openai, gemini, claude etc. models can be put as an option beside the llama3:7b local model
    * i dont think i will do it tho
